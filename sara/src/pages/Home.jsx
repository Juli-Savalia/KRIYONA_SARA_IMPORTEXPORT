          ...
          <section className="py-28">
            <div class="container">
              <h3 className="text-4xl text-center py-4 font-bold">
                Certificate : (<font className="text-mainblue"> EIBM </font>
                Certificate Image)
              </h3>
              <p className="pt-3 text-mainblue text-center">Our Extra Ordinary Way to Appreciate Your Achievement</p>
              ...
              <marquee>Export Import bussiness management certificate with a lifetime online certification facility is a best way to showcase your Genuine Achievement professionally.</marquee>
            </div>
          </section>
          {/* 7th section */}
          <section className="py-28">
            <div className="container">
            <h3 className="text-4xl text-center py-4 font-bold">
                <font className="text-mainblue"> Export Import </font>
                Awareness Seminar
              </h3>
              <p className="pt-3 text-mainblue text-center">Media Coverage plus Experience of our Studentss</p>
              <div>
              </div>
            </div>
          </section>
